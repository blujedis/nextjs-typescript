...
const Privacy: FC<{ name?: string; }> = ({ name }) => {
  ...
  return (
    <Layout title="Privacy" subtitle="Site Privacy Policy">
      <h1 className="page-name">{name.toUpperCase()} Privacy Policy</h1>
      <p>Effective date: September 16, 2019</p>
      <p>{name.toUpperCase()} ("us", "we", or "our") operates
      the http://www.{name.toLowerCase()}.com website (the "Service").</p>
      <p>This page informs you of our policies regarding the collection, use,
      and disclosure of personal data when you use
      ...
      Privacy Policy have the same meanings as in our Terms and Conditions, accessible
  from http://www.{name.toLowerCase()}.com</p>
  ...
  limited to:</p>
      ...
      (e.g. IP address), browser type, browser version, the
      pages of our Service that you visit, the time and date of your visit,
      the time spent on those pages, unique device
  identifiers and other diagnostic data.</p>
      ...
      anonymous unique identifier. Cookies are sent to
      your browser from a website and stored on your device. Tracking
      technologies also used are beacons, tags, and scripts
  to collect and track information and to improve and analyze our Service.</p>
      ...
      a cookie is being sent. However, if you do
  not accept cookies, you may not be able to use some portions of our Service.</p>
      ...
      <h2>Use of Data</h2>
      <p>{name.toUpperCase()} uses the collected data for various purposes:</p>
      <ul>
      ...
      the data protection laws may differ than those
  ...
  that transfer.</p>
      <p>{name.toUpperCase()} will take all steps reasonably necessary to ensure
  ...
  information.</p>
      ...
      <p>{name.toUpperCase()} may disclose your Personal Data in the good faith
      belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of {name.toUpperCase()}</li>
  ...
  Personal Data, we cannot guarantee its absolute security.</p>
      ...
      Service ("Service Providers"), to provide the
  ...
  party sites or services.</p>
      ...
      anyone under the age of 18. If you are a parent
      or guardian and you are aware that your Children has provided us with
  ...
  effective when they are posted on this page.</p>
      ...
      <ul>
        <li>By email: support@{name.toLowerCase()}.com</li>
      </ul>
