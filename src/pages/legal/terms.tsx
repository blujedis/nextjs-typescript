...
const Terms: FC<{ name?: string; }> = ({ name }) => {

  name = name || 'Create Next App';

  return (
    <Layout title="Terms" subtitle="Site Terms and Conditions">
      <h1 className="page-name">{name.toUpperCase()} Terms &amp; Conditions</h1>
      <p>These terms and conditions outline the rules and regulations for the
        use of {name.toUpperCase()}'s Website.</p>
      <span style={{ textTransform: 'capitalize', fontWeight: 'bolder' }}>
        {name.toUpperCase()}</span> is located at:<br />
      <address>4006-9120 Double Diamond Pkwy, Reno<br />NV - 85921-4842, USA<br /></address>
      <p>By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use {name.toUpperCase()}'s website
        if you do not accept all of the terms and conditions stated on this page.</p>
      <p>The following terminology applies to these Terms and Conditions,
      Privacy Statement and Disclaimer Notice and any
      ...
      the Client or ourselves. All terms refer to
    ...
    people visiting. Some of our affiliate / advertising partners may also use cookies.</p>
      <h2>License</h2>
      <p>Unless otherwise stated, {name.toUpperCase()} and/or it’s licensors
      own the intellectual property rights for all material
        on {name.toUpperCase()}. All intellectual property rights are reserved. You may view and/or print pages from
    http://www.{name.toLowerCase()}.com for your own personal use subject to
    restrictions set in these terms and conditions.</p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from http://www.{name.toLowerCase()}.com</li>
        <li>Sell, rent or sub-license material from http://www.{name.toLowerCase()}.com</li>
        <li>Reproduce, duplicate or copy material from http://www.{name.toLowerCase()}.com</li>
      </ol>
      <p>Redistribute content from {name.toUpperCase()} (unless content is specifically made for redistribution).</p>
      <h2>User Comments</h2>
      <ol>
        <li>This Agreement shall begin on the date hereof.</li>
        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
        material and data ('Comments') in areas of the website.
          {name.toUpperCase()} does not screen, edit, publish or review
          Comments prior to their appearance on the website and Comments do not reflect the views or opinions ofEG
          Auctions, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or
          opinion. To the extent permitted by applicable laws
          {name.toUpperCase()} shall not be responsible or liable for the
          Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of
      and/or posting of and/or appearance of the Comments on this website.</li>
        <li>{name.toUpperCase()} reserves the right to monitor all Comments and
        to remove any Comments which it considers in its
      absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
        <li>You warrant and represent that:<ol>
          <li>You are entitled to post the Comments on our website and have
             all necessary licenses and consents to do so;</li>
          ...
          indecent or otherwise unlawful material or
        ...
        <li>You hereby grant to <strong>{name.toUpperCase()}</strong> a
        non-exclusive royalty-free license to use, reproduce, edit
      and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
      </ol>
      ...
      <ol start={2}>
        ...
        to other Web site information so long as the
        link: (a) is not in any way misleading; (b) does not falsely imply sponsorship, endorsement or approval of the
      linking party and its products or services; and (c) fits within the context of the linking party's site.</li>
      ...
      benefit to us from the visibility associated
      with the hyperlink outweighs the absence of COMPANY-NAME; and (d) where the link is in the context of general
      resource information or is otherwise consistent with editorial content in a newsletter or similar product
    furthering the mission of the organization.</p>
    ...
    linking party and it products or services; and (c) fits within the context of the linking party's site.</p>
      <p>If you are among the organizations listed in paragraph 2 above and
      are interested in linking to our website, you
    must notify us by sending an e-mail to <a href="mailto:support@{name.toLowerCase()}.com" title="Send an email to support@{name.toLowerCase()}.com">support@{name.toLowerCase()}.com</a>.
      ...
      a list of any URLs from which you intend to link to our Web site, and a
    list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
      ...
      <p>No use of {name.toUpperCase()}s logo or other artwork will
      be allowed for linking absent a trademark license agreement.</p>
      <h2>Iframes</h2>
    ...
    techniques that alter in any way the visual presentation or appearance of our Web site.</p>
      ...
      link to our Web site. You agree to immediately remove all links
      to our Web site upon such request. We also reserve
      the right to amend these terms and conditions and its linking policy
      at any time. By continuing to link to our Web
    ...
    obligation to do so or to respond directly to you.</p>
    ...
    kept up to date.</p>
      ...
      criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third
    party rights.</p>
      <h2>Disclaimer</h2>
      <p>To the maximum extent permitted by applicable law, we exclude
      all representations, warranties and conditions
      relating to our website and the use of this website (including,
      without limitation, any warranties implied by law
      in respect of satisfactory quality, fitness for purpose and/or the use of reasonable care and skill). Nothing in
    this disclaimer will:</p>
      ...
      the subject matter of this disclaimer, including liabilities arising in contract, in tort (including negligence)
